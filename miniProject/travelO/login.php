...
<body>
    ...
    <!-- login form section starts  here -->
        <section class="login">
            <h1 class="heading-title">Enter your credentials here</h1>
            <form action="login_form.php" method="post" class="log-form">
                <div class="flex">
                    <div class="inputBox">
                        <span>email :</span>
                ...
                <input type="submit" value="submit" class="btn" name="send" onclick="book.php">
                <div class="remember_me"><input type="checkbox" name="remember_me"><span>Remember Me</span></div>
                <div class="down">
                
                <a href="forgotPassword.php" class="forpass">Forgot Password</a>
                <a href="register" class="reg">New Registration</a></div>
